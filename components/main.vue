    ...
    <div class="main">
        <div class="main__menu">
            <div class="main__button-logo-wrapper" v-click-outside="onClickOutside" :class="{'main__button-logo-wrapper-fixed' : statusMenu}">
                ...
                <svg  viewBox="0 0 82 31" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<style lang="sass">
    ...
    .main 
        width: 100%
        background: linear-gradient(180deg, rgba(53, 66, 103, 0.0001) -68%, #151824 95.04%), url('../assets/main.jpg') no-repeat 
    ...
    .main__button-logo-wrapper-fixed
        position: fixed
