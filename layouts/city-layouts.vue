<template>
    <div class="city-layouts">
        <div class="city-layouts-wrapper">
            <div class="main__menu">
                <div class="main__button-logo-wrapper" v-click-outside="clickMobileMenuLink" :class="{'city-layouts__logo-animation' : statusMenu}">
                    <div class="main__button-menu-mobile-wrapper" @click="clickMenu()">
                        <div class="main__button-menu-mobile">
                            <div class="main__button-menu-mobile-line"></div>
                            <div class="main__button-menu-mobile-line"></div>
                            <div class="main__button-menu-mobile-line"></div>
                        </div>
                        <span class="main__button-menu-mobile-wrapper-click-default" :class="{'main__button-menu-mobile-wrapper-click-animation' : statusMenu}"></span>
                    </div>
                    <svg  viewBox="0 0 82 31" fill="none" xmlns="http://www.w3.org/2000/svg" :class="{'city-layouts__svg' : statusMenu}">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M81.458 12.0851C81.0914 10.9164 80.5812 9.85893 79.8639 8.93664C79.1465 8.01436 78.2698 7.34649 77.2336 6.84559C76.9387 6.68658 76.58 6.52756 76.2771 6.44806C76.2771 6.44806 76.1655 6.38445 76.0619 6.38445C76.0141 6.38445 75.9583 6.38445 75.9025 6.32879C75.8627 6.32879 75.8069 6.32879 75.8069 6.27314L75.0497 6.11412C74.4917 6.01871 73.7744 5.97101 72.9454 6.01871C71.718 6.07437 70.634 6.33675 69.6775 6.78199C68.6413 7.29084 67.7646 8.0064 67.0472 8.86509C66.3299 9.78737 65.8197 10.7971 65.4531 12.0215C65.1024 13.1823 64.943 14.5022 64.943 15.822C64.943 17.1975 65.1024 18.4696 65.4611 19.6384C65.8277 20.8071 66.3936 21.8646 67.0552 22.7392C67.5733 23.3514 68.1312 23.8523 68.8087 24.3134C69.1116 24.5201 69.3666 24.6712 69.6855 24.8223H69.7253C69.7253 24.8223 69.7731 24.8223 69.7731 24.87C69.8073 24.87 69.8232 24.8859 69.8379 24.9008C69.8506 24.9136 69.8625 24.9256 69.8847 24.9256C70.4028 25.18 70.9687 25.3232 71.5825 25.4345C73.3758 25.7843 74.9142 25.5378 74.9142 25.5378C75.7351 25.4345 76.5083 25.18 77.2256 24.87C78.3017 24.3611 79.1704 23.6535 79.8958 22.7869C80.6131 21.9282 81.1232 20.8548 81.4899 19.6861C81.8406 18.5173 82 17.2452 82 15.8697C82 14.5022 81.7928 13.2301 81.4819 12.0533L81.458 12.0851ZM69.4464 13.1983C69.6536 12.4032 69.9086 11.632 70.2673 11.0197C70.626 10.4155 71.0883 9.90664 71.5984 9.5568C72.1165 9.19902 72.7302 9.00025 73.3918 9.00025C74.0613 9.00025 74.6272 9.14336 75.1453 9.50115C75.6554 9.85098 76.0619 10.2962 76.4206 10.8687C76.7793 11.4809 77.0423 12.1408 77.2416 12.9518C77.4568 13.7628 77.5604 14.5817 77.5604 15.496V15.7981C77.5604 16.7125 77.4568 17.6268 77.3053 18.4378C77.0981 19.2567 76.843 19.9643 76.4844 20.5845C76.1257 21.1888 75.6634 21.642 75.1453 21.9997C74.6352 22.3575 74.0294 22.5086 73.3519 22.5086C72.6824 22.5086 72.0766 22.3496 71.5586 21.9997C71.0405 21.642 70.5782 21.1888 70.2195 20.5686C69.8529 19.9643 69.5978 19.2567 69.3906 18.4378C69.1913 17.6268 69.1355 16.7125 69.1355 15.7981C69.1913 14.9236 69.2949 14.0172 69.4543 13.2062L69.4464 13.1983ZM58.1999 25.7127L56.2072 27.9946L56 28.2013L56.2072 31H59.2839L62.5199 27.3904V15.9095L62.4243 15.0349L58.1999 17.2134V25.7127Z" fill="white"/>
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M32.2789 5.22177L30.2657 3.00409L30 2.81535L30.2094 0L33.3097 0.0471846L36.6435 3.61749V15.2328L36.5469 15.8776L32.2789 13.6757V5.22177ZM60.8499 8.34382C61.5747 9.25606 62.09 10.302 62.4605 11.458L62.4766 11.4265C62.8389 12.5904 63 13.8487 63 15.2013C63 16.5618 62.8389 17.8201 62.4846 18.9761C62.1142 20.1321 61.5988 21.1938 60.8741 22.0431C60.1493 22.9003 59.2635 23.6002 58.1764 24.1035C57.4517 24.4102 56.6706 24.6618 55.8411 24.7641C55.8411 24.7641 54.287 25.0079 52.4751 24.6618C51.8551 24.5517 51.2833 24.4102 50.7679 24.1585C50.7387 24.1585 50.7246 24.1437 50.7111 24.1294C50.6985 24.1162 50.6865 24.1035 50.6632 24.1035C50.6632 24.0563 50.6069 24.0563 50.6069 24.0563H50.5666C50.2445 23.9069 49.9868 23.7575 49.6808 23.553C49.0044 23.0969 48.4326 22.6014 47.9092 21.9959C47.2408 21.1309 46.6691 20.0849 46.2987 18.9289C45.9444 17.7729 45.7833 16.5146 45.7833 15.1541C45.7833 13.8487 45.9363 12.5433 46.2906 11.3951C46.6611 10.184 47.1764 9.18528 47.9012 8.27304C48.6259 7.42372 49.5117 6.71595 50.5586 6.21265C51.5249 5.77226 52.6201 5.51274 53.8602 5.45769C54.6977 5.41051 55.4224 5.45769 55.9861 5.55206L56.7511 5.70934C56.7511 5.76439 56.8075 5.76439 56.8477 5.76439C56.9122 5.81944 56.9605 5.81944 57.0088 5.81944C57.1135 5.81944 57.2262 5.88235 57.2262 5.88235C57.5322 5.96099 57.8946 6.11828 58.1925 6.27556C59.2394 6.771 60.1252 7.43158 60.8499 8.34382ZM51.2028 10.4042C50.8404 11.0098 50.5827 11.7726 50.3814 12.559L50.3895 12.5668C50.1828 13.3588 50.1252 14.2427 50.0695 15.0975V15.0975L50.0674 15.1305C50.0674 16.0349 50.1157 16.9393 50.325 17.7414C50.5344 18.5514 50.7921 19.2513 51.1545 19.849C51.5168 20.4624 51.9839 20.9107 52.4993 21.2645C53.0227 21.6106 53.6428 21.7679 54.3272 21.7679C54.9956 21.7679 55.6237 21.6184 56.1391 21.2645C56.6545 20.9107 57.1215 20.4624 57.4758 19.8647C57.8382 19.2513 58.104 18.5514 58.3053 17.7414C58.4663 16.9393 58.5791 16.0349 58.5791 15.1305V14.8317C58.5791 13.9273 58.4663 13.1173 58.257 12.3152C58.0476 11.5131 57.7899 10.8603 57.4275 10.2548C57.0652 9.68858 56.6464 9.24819 56.1391 8.90217C55.6157 8.54829 55.0439 8.40673 54.3675 8.40673C53.683 8.40673 53.071 8.60333 52.5556 8.95722C52.0322 9.30324 51.5652 9.80654 51.2028 10.4042ZM38.9627 5.53633H43.3111V25H38.9627V5.53633Z" fill="white"/>
                ...
                <div class="main__menu-links" :class="{'main__menu-links-width' : statusMenu}">
                    ...
                    <span @mouseover="borderLinkSignIn = true" @mouseleave="borderLinkSignIn = false">
                        <nuxt-link no-prefetch to="/admin/home/" class="main__menu-link" style="height: 100%">
                            Sign in
            ...
            <div class="mobile-menu" :class="{'mobile-menu-disabled' : statusMenu}">
                <div class="mobile-menu__links">
                    <a href="#" class="mobile-menu__link" v-scroll-to="'#Articles'"  @click="clickMobileMenuLink()">Articles</a>
                    <a href="#" class="mobile-menu__link" v-scroll-to="'#Locations'" @click="clickMobileMenuLink()">Locations</a>
                    <a href="#" class="mobile-menu__link" v-scroll-to="'#Videos'" @click="clickMobileMenuLink()">Videos</a>
...
<script>
    export default {
        data() {
            return {
                statusMenu: false,
                borderLinkArticles: null,
                borderLinkLocations: null,
                borderLinkVideos: null,
                borderLinkSignIn: null,
                learnMore1: false,
                learnMore2: false,
                learnMore3: false
            }
...
<style lang="sass" scoped>
    ...
    .city-layouts__logo-animation
        transition: all 0.4s linear

    .main__button-menu-mobile
        display: flex
        flex-direction: column
        align-items: center
        min-height: 10px
    ...
    .main__button-menu-mobile-wrapper-click-default
        width: 54px
        height: 54px
        position: absolute
        background: #101213
    ...
    .main__button-menu-mobile-wrapper-click-animation
        transform: scale(1)
    ...
    .main__button-menu-mobile-wrapper:hover
